                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{route('dashboard.menu.edit-menu.patch', $menu)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method("PATCH")
                                        <img src="/storage/{{$menu->picture ?? ""}}" class="img-thumbnail mb-4" style="width: 400px; height: 300px; object-fit: cover;" id="previewImage">
                                        ...
                                        <div class="form-group">
                                            <input name="name" style="font-size: 16px;" type="text" class="form-control input-default " placeholder="Nama Menu" value="{{$menu->name}}">
                                        </div>

                                        <div class="form-group">
                                            <input name="price" style="font-size: 16px;" type="number" class="form-control input-default " placeholder="Harga" value="{{$menu->price}}">
                                        </div>

                                        <div class="form-group">
                                            <input name="min_order" style="font-size: 16px;" type="number" class="form-control input-default " placeholder="Minimal Order Produk" value="{{$menu->min_order}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <select name="category" class="form-control form-control-lg">
                                                ...
                                                @if($menu->category == "Makanan")
                                                    <option selected style="font-size: 16px;">Makanan</option>
                                                    <option style="font-size: 16px;">Minuman</option>
                                                @else
                                                    <option style="font-size: 16px;">Makanan</option>
                                                    <option selected style="font-size: 16px;">Minuman</option>
                                                @endif
                                            </select>
                                        </div>

                                        <div class="form-group">
                                            <textarea name="description" cols="30" rows="5" class="form-control" placeholder="Deskripsi Menu">{{$menu->description}}</textarea>
                                        </div>
