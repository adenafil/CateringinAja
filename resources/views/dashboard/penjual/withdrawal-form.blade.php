                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mm-active">
                        <a class="" href="{{route('dashboard.widthdrawalHistory')}}" aria-expanded="false">
                            <i class=""><img src="/helper/history-withdrawal-hover.png" style="width: 26px; height: 26px;"></i>
            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dana</a></li>
                                ...
                                <div class="basic-form">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <input style="font-size: 16px;" type="text" class="form-control input-default " placeholder="Jumlah Dana Yang Ditarik">
                                        </div>

                                        <div class="form-group">
                                            <select class="form-control form-control-lg">
                                                <option style="font-size: 16px;">Category Pembayaran</option>
                                                <option style="font-size: 16px;">BRI</option>
                                                <option style="font-size: 16px;">BCA</option>
                                                <option style="font-size: 16px;">Mandiri</option>
                                                <option style="font-size: 16px;">Danamon</option>
                                                <option style="font-size: 16px;">Cimb Niaga</option>
                                                <option style="font-size: 16px;">JAGO</option>
                                                <option style="font-size: 16px;">BNI</option>
                                                <option style="font-size: 16px;">ShopeePay</option>
                                                <option style="font-size: 16px;">Dana</option>
                                                <option style="font-size: 16px;">Gopay</option>
                                                <option style="font-size: 16px;">OVO</option>
                                            </select>
                                        </div>

                                        <div class="form-group">
                                            <input style="font-size: 16px;" type="text" class="form-control input-default " placeholder="Nama">
                                        </div>

                                        <div class="form-group">
                                            <input style="font-size: 16px;" type="text" class="form-control input-default " placeholder="No Pembayaran Anda">
                                        </div>


                                        <button type="button" class="btn btn-sm btn-primary">Tarik</button>
